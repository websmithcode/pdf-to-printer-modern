...
test("fixes path for Electron apps", () => {
  const path =
    "/Users/websmithcode/My.app/Contents/Resources/app.asar/node_modules/foo/binary";
  ...
  expect(fixPathForAsarUnpack(path)).toBe(
    "/Users/websmithcode/My.app/Contents/Resources/app.asar.unpacked/node_modules/foo/binary"
  );
});
